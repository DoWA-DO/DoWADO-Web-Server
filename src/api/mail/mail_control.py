...
import logging
from src.api.user_teachers.teacher_service import save_verification_code_service # 위치 이동 필요
...
async def send_email_handler(email_request: EmailRequest):
    ...
    # 인증 코드 저장
    await save_verification_code_service(email_request.to_email, verification_code)
